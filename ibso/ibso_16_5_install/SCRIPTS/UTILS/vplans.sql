...
-- ���⮬� ����� ��� ᮧ���� �⤥���� �����, �������� �㤠 �ਯ�,
-- ᤥ���� �� ⥪�饩 � �������� �ਯ� ��������:
-- <��� ����� sql*plus> <connect_string> @vplans.sql
-- ���ਬ��:
-- plus80w ins/ibs@cent @vplans.sql
--
-- � ����� ࠡ��� ᮧ������ � 㤠������:
-- 1) �� �ᯮ����⥫��� �ਯ�: __xplanv__.sql, __xplan__.sql � __vplans__.sql
-- 2) ⠡��� ��� �믮������ explain plan. �� ��� �������� ����ᮬ PLAN_TABLE,
--    �� 㬮�砭�� �� plan_table_for_views
--
