 ...
 * RENAME _usr_sets.sql to usr_sets.sql in
 * upgrade ROOT directory and change it.
 * Or CREATE new usr_sets.sql using ABOVE part
 * of settings.sql as EXAMPLE.
 */
SET TERMOUT OFF
@@usr_sets
SET TERMOUT ON

--audit\audinit.sql and audit\a_defs.sql and AUDMGR\upgrade\audm.sql
def AUD_OWNER='AUD' --Schema Name for AUDIT
