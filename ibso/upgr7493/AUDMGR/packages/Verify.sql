 ...
 */
   ...
   cnt_sym  integer; -- ������� �������� ������ ������ ������ � ����������
--
   PASSWORD_IS_EMPTY constant varchar2(100) := '������ �� ����� ���� ������';
   PASSWORD_IS_NAME constant varchar2(100) := '������, ����������� � ������ ������������, ��������.';
   PASSWORD_IS_SHORT constant varchar2(100) := '����� ������ ������ ���� �� ������ 8 ��������.';
   PASSWORD_IS_SIMPLE constant varchar2(100) := '������� ������ ��������.';
   PASS_CONTAINS_BAD_CHARS constant varchar2(100) := '������ �������� ������������ �������.';
   PASS_MUST_CONTAIN_DIGITS constant varchar2(100) := '������ ������ ��������� ���� �� ���� �����.';
   PASS_MUST_CONTAIN_LETTERS constant varchar2(100) := '������ ������ ��������� ���� �� ���� �����.';
   PASS_MUST_CONTAIN_DELIMETERS constant varchar2(100) := '������ ������ ��������� ���� �� ���� ���� ����������.';
   PASSES_MUST_DIFFER_IN_N_CHARS constant varchar2(100) := '����� ������ �� ������� ������ ���������� ���� �� �� %1 �������.';
   PASS_CONTAINS_N_REPEATED_CHARS constant varchar2(100) := '� ������ ���� ������, ������� ���������� ������ %1 ����, ��� ���������.';
   PASS_CONTAINS_SIMP_COMBINATION constant varchar2(100) := '������ �������� ����������� ������� ���������� ��������, ��������� ��������.';
   PASS_CONTAINS_KEYBOARD_SEQ constant varchar2(100) := '� ������ ���� �������, ��������� � ���������� ������ ���-��� ������ %1 ���.';
   PASSWORD_IS_BATTLEPASS constant varchar2(100) := '������, ����������� � �����������������, ��������.';
--
...
-- �� �������� ���������� �� ������ ����������
   chararray := 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ!#$%*+-=?_�������������������������������������Ũ��������������������������';
   punctarray:= '!#$%*+-=?_';
   badsymbols:= ' (){}[].,;:<>/|\"`''';
   qwerty_arrayLo    := '`1234567890-= qwertyuiop[]\ asdfghjkl;''\ \zxcvbnm,./';
   qwerty_array1Lo   := '�1234567890-= ������������\ �����������\ \���������.';
--
