...
-- ATTRIBUTE_MAPPING_SERVICE
@Packages/attribute_mapping_service1.sql
-- BINDINGS
@Packages/binding1.SQL
-- CALENDAR_MGR
...
@Packages/lconv1.SQL
-- MAPEX_MGR
@Packages/map_mgr1.SQL
-- METHOD
@Packages/method1.SQL
-- METHOD_GROUP
@Packages/met_grp1.SQL
-- METHOD_MGR
...
-- NUM_INTERFACE
@Packages/num_interface1.SQL
-- NUM_MGR
@Packages/num_mgr1.SQL
-- OPT_MGR
...
-- PATCH_TOOL
@Packages/patch_tool1.SQL
-- PD_MGR
@Packages/pd_mgr1.sql
-- PLP$PARSER
@Packages/parser1.SQL
-- PLP2PLSQL
@Packages/2plsql1.SQL
-- RCS_LOCK
@Packages/rcs_lck1.SQL
-- REPL_MGR
@Packages/repl1.SQL
-- REPL_UTILS
@Packages/repl_ut1.SQL
-- REPORT_MGR
@Packages/report1.SQL
-- RTLOBJ
@Packages/rtlobj1.SQL
-- RULES
@Packages/rule1.SQL
-- RUNPROC_MGR
@Packages/run_mgr1.SQL
-- RUNPROC_PKG
@Packages/runproc1.SQL
-- SECADMIN
@Packages/sa1.SQL
-- SESSION_INITIALIZATION_SERVICE
...
@Packages/types1.SQL
-- USER_CONTEXT
@Packages/user_context1.SQL
-- UTL_FILE
@Packages/utlfile1.SQL
-- XRC_XMLDOM
@Packages/xmldom1.SQL
-- XRC_XMLPARSER
@Packages/xmlprs1.SQL
-- ADMIN_MGR
...
-- ATTRIBUTE_MAPPING_SERVICE
@Packages/attribute_mapping_service2.plb
-- BINDINGS
...
-- MESSAGE
@Packages/message2.SQL
-- METHOD
@Packages/method2.plb
-- METHOD_GROUP
@Packages/met_grp2.SQL
-- METHOD_MGR
...
-- NUM_INTERFACE
@Packages/num_interface2.SQL
-- NUM_MGR
@Packages/num_mgr2.SQL
-- OPT_MGR
...
@Packages/rtl1_2.plb
-- RTLOBJ
@Packages/rtlobj2.SQL
-- RULES
@Packages/rule2.plb
-- RUNPROC_MGR
@Packages/run_mgr2.SQL
-- RUNPROC_PKG
...
@Packages/types2.SQL
-- USER_CONTEXT
@Packages/user_context2.plb
-- UTILS
@Packages/utils2.SQL
-- UTL_FILE
@Packages/utlfile2.SQL
-- VALMGR
@Packages/valmgr2.plb
-- XRC_XMLDOM
@Packages/xmldom2.SQL
-- XRC_XMLPARSER
@Packages/xmlprs2.SQL
-- PROCEDURES
@Packages/PROC.SQL
@Packages/RPTQUEUE.SQL
-- drop obsolete
@Packages/opt/drop_pkg.SQL
set timing off
