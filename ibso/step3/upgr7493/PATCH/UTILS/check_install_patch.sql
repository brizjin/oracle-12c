...
define OWNER = &&IBSO_OWNER --ACCEPT OWNER PROMPT 'Enter IBSO OWNER schema name (&&IBSO_OWNER): '  default &&IBSO_OWNER
...
define AUD_USER = &&AUD_OWNER --ACCEPT AUD_USER PROMPT 'Enter AUDIT schema name (&&AUD_OWNER): ' default &&AUD_OWNER
