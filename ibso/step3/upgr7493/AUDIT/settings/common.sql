...
define DIARY_TBS = &&TUSER --accept DIARY_TBS char format a30 prompt 'Tablespace for TABLES [&&TUSER]: ' default &&TUSER
define DIARY_IDX_TBS = &&TSPACEI --accept DIARY_IDX_TBS char format a30 prompt 'Tablespace for indexes [&&TSPACEI]: ' default &&TSPACEI
prompt
prompt Please enter tablespaces for QUARTERLY diaries tables and indexes:
define Q_DIARY_TBS = &&TUSER --accept Q_DIARY_TBS char format a30 prompt 'Tablespace for TABLES [&&TUSER]: ' default &&TUSER
define Q_DIARY_IDX_TBS = &&TSPACEI --accept Q_DIARY_IDX_TBS char format a30 prompt 'Tablespace for indexes [&&TSPACEI]: ' default &&TSPACEI
