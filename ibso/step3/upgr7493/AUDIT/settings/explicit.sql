...
define DIARY_TBS = &&DIARY_TBS --accept DIARY_TBS char format a30 prompt 'Tablspace for TABLE [&&DIARY_TBS]: ' default &&DIARY_TBS
define DIARY_IDX_TBS = &&DIARY_IDX_TBS --accept DIARY_IDX_TBS char format a30 prompt 'Tablespace for INDEX [&&DIARY_IDX_TBS]: ' default &&DIARY_IDX_TBS
@settings/set_part
...
prompt
prompt Enter tablspaces for MONTHLY partition &&STEP_NUMBER
define DIARY_TBS = &&DIARY_TBS --accept DIARY_TBS char format a30 prompt 'Tablespace for TABLE [&&DIARY_TBS]: ' default &&DIARY_TBS
define DIARY_IDX_TBS = &&DIARY_IDX_TBS --accept DIARY_IDX_TBS char format a30 prompt 'Tablespace for INDEX [&&DIARY_IDX_TBS]: ' default &&DIARY_IDX_TBS
@settings/set_part
