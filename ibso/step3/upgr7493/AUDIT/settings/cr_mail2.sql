...
define RECPT = &&RECPT --accept RECPT    char format a30 prompt 'Main recipient email [&&RECPT]: '  default &&RECPT
define RNAME = &&RECPT --accept RNAME    char format a30 prompt 'Main recipient name  [&&RECPT]: '  default &&RECPT

prompt
prompt CONNECT notifications

define STATUS = &&STATUS --accept STATUS   char format a30 prompt 'Status for CONNECT notifications [&&STATUS]: '  default &&STATUS

exec mail_mgr.set_notification('&&Owner','CONNECT','LOGON_SUCCESS','LOGON_SUCCESS','&&Sender','&&Sname','������� ����� ����������������� �������������')
exec mail_mgr.set_notification_status('&&Owner','CONNECT','&&Status')
exec mail_mgr.set_recipient('&&Owner','CONNECT','&&Recpt','&&Rname')

exec mail_mgr.set_notification('&&Owner','BAD_CONNECT','LOGON_ERROR','LOGON_ERROR','&&Sender','&&Sname','������� ������ ����� ����������������� �������������')
exec mail_mgr.set_notification_status('&&Owner','BAD_CONNECT','&&Status')
exec mail_mgr.set_recipient('&&Owner','BAD_CONNECT','&&Recpt','&&Rname')

exec mail_mgr.set_notification('&&Owner','LOGON_WARNING','LOGON_WARNING','LOGON_WARNING','&&Sender','&&Sname','����� � ���������� ������')
...
define STATUS = &&STATUS --accept STATUS   char format a30 prompt 'Status for EDOC_BAD_PKDB notification [&&STATUS]: '  default &&STATUS

exec mail_mgr.set_notification('&&Owner','EDOC_BAD_PKDB','EDOC_BAD_PKDB','EDOC_BAD_PKDB','&&Sender','&&Sname','������� ������ �������� ����������� ���')
