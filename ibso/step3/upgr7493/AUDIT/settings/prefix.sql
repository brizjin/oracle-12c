...
define M_TBS_PREFIX = &&TUSER --accept M_TBS_PREFIX char format a30 prompt 'Tablespace for TABLES [&&TUSER]: ' default &&TUSER
define M_IDX_TBS_PREFIX = &&TSPACEI --accept M_IDX_TBS_PREFIX char format a30 prompt 'Tablespace for INDEXES [&&TSPACEI]: ' default &&TSPACEI
prompt
prompt Prefixes for QUARTERLY diaries:
define Q_TBS_PREFIX = &&TUSER --accept Q_TBS_PREFIX char format a30 prompt 'Tablespace for TABLES [&&TUSER]: ' default &&TUSER
define Q_IDX_TBS_PREFIX = &&TSPACEI --accept Q_IDX_TBS_PREFIX char format a30 prompt 'Tablespace for INDEXES [&&TSPACEI]: ' default &&TSPACEI
