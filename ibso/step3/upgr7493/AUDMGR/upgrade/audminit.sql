...
define dt = &&AUDM_TDEF --ACCEPT dt PROMPT 'Default tablespace (&&AUDM_TDEF) :'  default &&AUDM_TDEF
define tt = &&AUDM_TTMP --ACCEPT tt PROMPT 'Temporary tablespace (&&AUDM_TTMP) :' default &&AUDM_TTMP
define it = &&AUDM_TSPACEI --ACCEPT it PROMPT 'Tablespace for indexes(&&AUDM_TSPACEI) :' default &&AUDM_TSPACEI
