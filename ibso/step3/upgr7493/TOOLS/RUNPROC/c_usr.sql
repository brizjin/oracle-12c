...
define RNAME = RUNPROC
define RPASS = RUNPROC
define RPATH = &&RPATH --ACCEPT RPATH PROMPT 'RUNPROC ini file path (&&rpath):' default &&RPATH

def

prompt JOBS_RUNPROC_USER setting
exec sysinfo.setvalue('JOBS_RUNPROC_USER',upper('&&RNAME'),'��� ������������ ������ RUNPROC ������� �������');
exec sysinfo.setvalue('JOBS_RUNPROC_USER',upper('&&RNAME'),'��� ������������ ������ RUNPROC ������� �������');
prompt JOBS_RUNPROC_INI setting
exec sysinfo.setvalue('JOBS_RUNPROC_INI','&&RPATH','���� � ����� ������������� ������ RUNPROC');
